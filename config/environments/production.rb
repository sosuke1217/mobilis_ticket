...
Rails.application.configure do
  ...
  # リバースプロキシ（Heroku）経由のため、X-Forwarded-Proto を信頼する。
  config.assume_ssl = true

  # HSTS と secure cookie は有効のまま、アプリ側の HTTP→HTTPS リダイレクトは行わない。
  # （Heroku がエッジで HTTPS を終端するため、リダイレクトするとループになることがある）
  ...
  # config.active_job.queue_name_prefix = "mobilis_production"
